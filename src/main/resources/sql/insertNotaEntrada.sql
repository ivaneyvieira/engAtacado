...
INSERT INTO sqldados.inv(invno, vendno, ordno, xfrno, issue_date, DATE, comp_date, ipi, icm,
                         ...
                         auxLong9, auxLong10, auxLong11, auxLong12, auxMoney6, auxMoney7, auxMoney8,
                         auxMoney9, auxMoney10, auxMoney11, auxMoney12, auxMoney13, l1, l2, l3, l4,
                         l5, l6, l7, l8, m1, m2, m3, m4, m5, m6, m7, m8, weight, carrno, packages,
                         storeno, indxno, book_bits, type, usernoFirst, usernoLast, nfStoreno, bits,
                         padbyte, auxShort1, auxShort2, auxShort3, auxShort4, auxShort5, auxShort6,
                         auxShort7, auxShort8, auxShort9, auxShort10, auxShort11, auxShort12,
                         auxShort13, auxShort14, bits2, bits3, bits4, bits5, s1, s2, s3, s4, s5, s6,
                         s7, s8, nfname, invse, account, remarks, contaCredito, contaDebito, nfNfse,
                         auxStr1, auxStr2, auxStr3, auxStr4, auxStr5, auxStr6, c1, c2)
SELECT @INVNO AS invno, :vendno AS vendno, @ordno AS ordno, 0 AS xfrno,
       CURRENT_DATE * 1 AS issue_date, CURRENT_DATE * 1 AS DATE, CURRENT_DATE * 1 AS comp_date,
       0 AS ipi, 0 AS icm, 0 AS freight, 0 AS netamt, @valor * 100 AS grossamt, 0 AS subst_trib,
       0 AS discount, @valor * 100 AS prdamt, 0 AS despesas, 0 AS base_ipi, 0 AS aliq, 1949 AS cfo,
       ...
       0 AS packages, @storeno, 0 AS indxno, 9 AS book_bits, 1 AS type /*Transferencia*/,
